...
public class AndroidCameraApi extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(in.gvc.image.recognize.R.layout.camera_layout);
        textureView = (TextureView) findViewById(in.gvc.image.recognize.R.id.texture);
        assert textureView != null;
        textureView.setSurfaceTextureListener(textureListener);
        takePictureButton = (Button) findViewById(in.gvc.image.recognize.R.id.btn_takepicture);
    ...
    protected void takePicture() {
        ...
        try {
            ...
            final CameraCaptureSession.CaptureCallback captureListener = new CameraCaptureSession.CaptureCallback() {
                ...
                public void onCaptureCompleted(CameraCaptureSession session, CaptureRequest request, TotalCaptureResult result) {
                    super.onCaptureCompleted(session, request, result);
                    Toast.makeText(AndroidCameraApi.this, "Capturing complete:" + file, Toast.LENGTH_SHORT).show();
                    //createCameraPreview();
                }
            };
    ...
    public void click_image(byte[] bytes)
    {
        ...
        try
        {
            ...
            if (entity != null)
            {
                ...
                textView.setText("");
                parseit(array,"regions",textView);
                textView.setText("\n");
    ...
    public void parseit(JSONArray array,String key,TextView textView) throws JSONException {
        for(int i=0;i<array.length();i++)
        {
            ...
            if(obj.has(key))
            {
                ...
                if(key.equals("regions"))
                    parseit(temp_array,"lines",textView);
                else if(key.equals("lines"))
                    parseit(temp_array,"words",textView);
                else if(key.equals("words")) {
                    textView = (TextView) findViewById(in.gvc.image.recognize.R.id.textView);
